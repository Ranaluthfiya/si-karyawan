...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td width="800"><font color="blue" size="4" face="arial"><b>Form Input Data Karyawan</b></font></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td width="165">NIK</td>
		<td><input type="text" name="nik" size="20" maxlength="9" style="text-transform: uppercase;">&nbsp;* gunakan kode NIK kemudian tambahkan angka ( ex : NIK01011001 )</td>
	</tr>
	<tr>
		<td height="36">&nbsp;</td>
		<td>Nama</td>
